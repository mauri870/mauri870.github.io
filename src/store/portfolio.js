    ...
    projects: [
      {
        ...
        description: 'Cloudradioo App is an desktop application builded with Electron, VueJs and Vuex that plays randomly all top 50 songs from the soundcloud charts.',
